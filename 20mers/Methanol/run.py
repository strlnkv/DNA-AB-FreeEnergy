...
simulation.reporters.append(StateDataReporter('C/log23.txt', 5000, step=True, potentialEnergy=True, temperature=True, volume=True, speed=True, separator='	'))#,append=True
simulation.reporters.append(DCDSubsetReporter('C/trj23.dcd', 5000, indices_list))
