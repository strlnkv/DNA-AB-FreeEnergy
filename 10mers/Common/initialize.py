...
#exclude solvent from trajectory and run a short relaxation
indices_list = []
...
simulation.reporters.append(StateDataReporter('log.txt', 5000, step=True, potentialEnergy=True, temperature=True, volume=True, speed=True, separator='	',append=True))#
simulation.reporters.append(DCDSubsetReporter('trj.dcd', 5000, indices_list))
simulation.step(500000)
